...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [x_h1, x_h2, cov1, cov2]=ZUPTaidedINS(u1,u2,zupt1, zupt2)
...
for k=2:N
    ...
    if zupt1(k)==true;
        ...
        [x_h1(:,k) quat1]=comp_internal_states(x_h1(:,k),dx,quat1);     % Subfunction located further down in the file.
