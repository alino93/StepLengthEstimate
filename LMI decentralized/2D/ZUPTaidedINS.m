...
[tiltE2,rollE2] = Tilt_Estimation([-u2(1,:)',-u1(2,:)',-u2(3,:)'],u2(5,:),u1(4,:),0.8);
...
for k=2:N
    ...
    [x_h2(:,k) quat2]=Navigation_equations2(x_h2(:,k-1),u_h2,quat2); % Subfunction located further down in the file.
